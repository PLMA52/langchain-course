...
def main():
    ...
    result = agent.invoke({"messages": HumanMessage(content="Search for 3 job postings for an AI engineer using LangChain in the Washington DC Area on LinkedIn and list their details?")})
